...
urlpatterns = [
    ...
    path('delete_property/<str:property_name>/', views.delete_property, name='delete_property-1'),
    path('update_property/<str:property_name>/', views.update_property, name='update_property-1')
